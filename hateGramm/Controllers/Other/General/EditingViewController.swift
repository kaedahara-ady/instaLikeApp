...
final class EditingViewController: UIViewController, UITableViewDataSource {
    ...
    private func createTableHeaderView() -> UIView {
        ...
        let profilePhotoButton = UIButton(
            frame: CGRect(x: (view.width-size)/2,
...
extension EditingViewController: FormTableViewCellDelegate {
