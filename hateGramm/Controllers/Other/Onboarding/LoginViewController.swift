...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        createAccountButton.addTarget(self, action: #selector(didTappedRegisterButton), for: .touchUpInside)
            ...
            password: password) { succes in
                DispatchQueue.main.async {
                    if succes {
                        ...
                        let alert = UIAlertController(title: "Log in Error", message: "We were unable to log you", preferredStyle: .alert)
