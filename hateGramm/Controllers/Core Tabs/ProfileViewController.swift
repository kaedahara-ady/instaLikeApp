...
extension ProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        //let model = userPosts[indexPath.row]
        let user = User(username: "Kazuha", bio: "", name: (first: "", last: ""),
                        profilePhoto: URL(string: "https://wwww.google.com")!,
                        birthDate: Date(),
                        gender: .male,
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let profileHeader = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: ProfileInfoHeaderCollectionReusableView.identifier,
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        ...
        for i in 0..<10{
            mockData.append(UserRelationShip(username: "@RealKazuha", name: "Kaedahara Kazuha", type: i % 2 == 0 ? .following : .not_following))
        }
