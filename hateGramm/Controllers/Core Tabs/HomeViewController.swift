...
class HomeViewController: UIViewController {
    ...
    private var tablView: UITableView = {
    ...
    private func createMockModels() {
        ...
        for x in 0..<2 {
            comments.append(PostComment(
                identifier: "\(x)",
                username: "@Hu Tao", text: "Hilichurls will be amazed by this post",
                createdDate: Date(),
                likes: [])
            )
        }
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tablView: UITableView, heightForFooterInSection section: Int) -> CGFloat {
        let subsecton = section % 4
        return subsecton == 3 ? 70 : 0
    }
